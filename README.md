## rmf_simulation (lyrical) - 2.7.0-1

The packages in the `rmf_simulation` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical rmf_simulation` on `Wed, 17 Jun 2026 03:46:10 -0000`
...
## rmf_simulation (rolling) - 2.6.1-1

The packages in the `rmf_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rmf_simulation --ros-distro rolling` on `Mon, 17 Nov 2025 06:36:39 -0000`
...
## rmf_simulation (jazzy) - 2.3.3-1

The packages in the `rmf_simulation` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rmf_simulation --ros-distro jazzy` on `Fri, 27 Jun 2025 01:30:12 -0000`
...
## rmf_simulation (kilted) - 2.5.0-1

The packages in the `rmf_simulation` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted rmf_simulation` on `Tue, 20 May 2025 18:28:46 -0000`
...
## rmf_simulation (rolling) - 2.5.0-1

The packages in the `rmf_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling rmf_simulation` on `Mon, 12 May 2025 04:29:39 -0000`
...
## rmf_simulation (rolling) - 2.4.1-1

The packages in the `rmf_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_simulation` on `Wed, 13 Nov 2024 02:25:10 -0000`
...
The packages in the `rmf_simulation` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --new-track --rosdistro jazzy --track jazzy rmf_simulation` on `Fri, 14 Jun 2024 19:56:10 -0000`
...
## rmf_simulation (rolling) - 2.4.0-1
