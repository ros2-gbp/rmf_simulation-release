...
%global pkg_name rmf_building_sim_gz_plugins
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-building-sim-gz-plugins
Version:        2.7.0
Release:        1%{?dist}
...
%changelog
* Wed Jun 17 2026 Luca Della Vedova <luca@openrobotics.org> - 2.7.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Luca Della Vedova <luca@openrobotics.org> - 2.6.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Luca Della Vedova <luca@openrobotics.org> - 2.6.1-2
- Autogenerated by Bloom

* Wed Apr 22 2026 Luca Della Vedova <luca@openrobotics.org> - 2.6.1-1
- Autogenerated by Bloom
